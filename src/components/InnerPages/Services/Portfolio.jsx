  ...
  function handleShowTabs() {
    isInView({
      ...
      callback(element) {
        ...
        const tabElement = document.querySelector("#" + element.getAttribute('data-tab'));
        if (tabElement) {
      ...
      whenOutOfView(element) {
        ...
        const tabElement = document.querySelector("#" + element.getAttribute('data-tab'));
        if (tabElement) {
          tabElement.classList.remove('current');
        }
      }
    });
                ...
                <div className={`cont ${index === 0 ? 'active' : ''}`} data-tab={`tab-${index + 1}`} key={index}>
                  ...
                  <div className="row justify-content-center">
                    <div className="col-md-11">
                      ...
                      {/* <Link href="/light/portfolio-grid-2" className="butn-circle d-flex align-items-center text-center mt-50">
                        <div className="full-width">
                          ...
                          <span className="full-width">View More</span>
                        </div>
