        ...
        <div className="sec-lg-head mb-80">
          <div className="row">
            ...
            <div className="col-lg-4 d-flex align-items-center">
              <div className="text">
                <p>Experience seamless integration of design and functionality with our expert web and mobile application development, UI/UX design, and brand identity services. At ApexNile, we transform your ideas into digital realities.</p>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="col-lg-4" key={item.id}>
                <div className="serv-item md-mb50 radius-10">
                  <div className="icon-img-60 mb-40">
                    <img src={`/${lightMode ? 'dark' : 'dark'}/${item.image}`} alt={item.title} />
                  </div>
