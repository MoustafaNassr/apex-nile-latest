...
function CallToAction({ lightMode, innerPageStyle }) {
  useEffect(() => {
    ...
    const elements = document.querySelectorAll('.hover-parent');
    elements.forEach(element => {
      element.addEventListener('mouseover', () => {
        element.querySelector('.text-hover-white').classList.add('text-white');
        element.querySelector('svg path').classList.add('fill-white');
      });
      element.addEventListener('mouseout', () => {
        element.querySelector('.text-hover-white').classList.remove('text-white');
          ...
          <div className="row ontop">
            <div className="col-11 d-flex align-items-center">
              ...
              <div className="ml-auto">
                <Link href="/dark/page-contact" className="butn-circle d-flex align-items-center text-center m-auto hover-parent">
                  <div className="full-width">
                    ...
                    <span className="full-width text-hover-white">Get In Touch</span>
                  </div>
