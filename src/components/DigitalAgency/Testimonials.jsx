      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-5 valign">
            <div className="cont">
              <div>
                <h6 className="sub-title mb-15 arrow">Since 2012</h6>
                <h3>Empowering Your Digital Transformation</h3>
                <div className="text mt-10 pb-30 bord-thin-bottom">
                  <p>At ApexNile, we are committed to delivering exceptional software solutions that drive success. Let us be your trusted partner in digital innovation.</p>
                </div>
                <div className="stauts d-flex mt-20">
                  <div className="item d-flex align-items-center mt-30">
                    <h2 className="mr-20">7k</h2>
                    <p className="fz-14">Satisfied Clients <br /> Worldwide</p>
                  </div>
                  <div className="item d-flex align-items-center ml-auto mt-30">
                    <h2 className="mr-20">13k</h2>
                    <p className="fz-14">Projects <br /> Successfully Delivered</p>
                  </div>
                </div>
              </div>
            </div>
                          ...
                          <div className="cont mb-40">
                            <div className="rate-stars mb-30 fz-12">
                              <span className={`rate ${mainColor ? 'main-color' : 'main-color2'}`}>
                                <i className="fas fa-star arrow"></i>
                                <i className="fas fa-star arrow"></i>
                                <i className="fas fa-star arrow"></i>
                                <i className="fas fa-star arrow"></i>
                                <i className="fas fa-star arrow"></i>
