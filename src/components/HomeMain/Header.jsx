  ...
  return (
    <header className="crev-header">
            ...
            <div className="caption">
              ...
              <div className="row mt-30">
                <div className="col-lg-5 offset-lg-1">
                  <div className="text">
                    <p>Apex Nile, your trusted software development partner. </p>
                    <p>We create cutting-edge websites, e-commerce platforms, and mobile apps. </p>
                    <p>Our ready-to-use templates and custom solutions drive your business forward with quality and innovation. Let us turn your ideas into reality.</p>
                  </div>
      ...
      <div className="main-img">
        <img src="/dark/assets/imgs/background/14.png" alt="" />
      </div>
