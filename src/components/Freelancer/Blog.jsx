...
function Blog() {
  return (
    <section className="blog-list-half crev section-padding sub-bg" data-scroll-index="6">
      <div className="container">
        <div className="sec-lg-head mb-80">
          <div className="row">
            <div className="col-lg-7">
              <h6 className="dot-titl-non mb-10">Our Blog</h6>
              <h2 className="fz-50">Latest News</h2>
            </div>
        ...
        <div className="row">
          {
            data.map((item, index) => (
              <div className="col-lg-6" key={item.id}>
                <div className={`item ${index !== data.length - 1 ? 'md-mb80' : ''}`}>
